...
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRhYmZma2dsZndkamZhYW5...';
...
async function checkTables() {
  ...
  try {
    ...
    if (messagesError) {
      console.log('❌ Error en tabla whatsapp_messages:', messagesError.message);
    ...
    if (templatesError) {
      console.log('❌ Error en tabla message_templates:', templatesError.message);
    } else {
