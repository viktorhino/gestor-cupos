  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <h2>Configuración:</h2>
        <p>
          <strong>URL:</strong> https://dabffkglfwdjfaanzpkm.supabase.co
        </p>
        <p>
          <strong>Clave:</strong>{" "}
          {supabase.supabaseKey ? "Presente" : "Faltante"}
        </p>
      </div>
      ...
      >
        ...
        <ol>
          ...
          <li>
            Actualizar el archivo <code>src/lib/supabase/config.ts</code>
          </li>
